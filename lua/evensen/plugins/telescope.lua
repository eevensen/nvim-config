...
-- Helps you quickly search and navigate
-- through files, buffers, git commits, and more.
return {
  { -- Fuzzy Finder (files, lsp, etc)
    ...
    config = function()
      ...
      vim.keymap.set('n', '<leader>t.', builtin.resume, { desc = 'Find Resume/repeat ("." for repeat)' })
      ...
      vim.keymap.set('n', '<leader>ts', builtin.builtin, { desc = 'Find Select Telescope' })
      vim.keymap.set('n', '<leader>tw', builtin.grep_string, { desc = 'Find current [W]ord' })
      ...
      vim.keymap.set('n', '<leader>tp', builtin.registers, { desc = 'Find Paste register' })
      vim.keymap.set('n', '<leader>tq', builtin.quickfix, { desc = 'Find Quickfix list' })
